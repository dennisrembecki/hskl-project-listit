 ...
 */
final class Version20220105071209 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_1E30D1ACE85441D8');
        $this->addSql('DROP INDEX IDX_1E30D1ACA76ED395');
        $this->addSql('CREATE TEMPORARY TABLE __temp__user_liste AS SELECT user_id, liste_id FROM user_liste');
        $this->addSql('DROP TABLE user_liste');
        $this->addSql('CREATE TABLE user_liste (user_id INTEGER NOT NULL, liste_id INTEGER NOT NULL, PRIMARY KEY(user_id, liste_id), CONSTRAINT FK_1E30D1ACA76ED395 FOREIGN KEY (user_id) REFERENCES "user" (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_1E30D1ACE85441D8 FOREIGN KEY (liste_id) REFERENCES liste (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO user_liste (user_id, liste_id) SELECT user_id, liste_id FROM __temp__user_liste');
        $this->addSql('DROP TABLE __temp__user_liste');
