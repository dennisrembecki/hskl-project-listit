 ...
 */
final class Version20220103231018 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE liste (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, creator_id INTEGER NOT NULL, favorit_id INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, category VARCHAR(255) NOT NULL COLLATE BINARY, type VARCHAR(255) NOT NULL COLLATE BINARY, rating VARCHAR(255) NOT NULL COLLATE BINARY, created DATETIME DEFAULT NULL, private BOOLEAN DEFAULT NULL, sort VARCHAR(255) DEFAULT NULL COLLATE BINARY, CONSTRAINT FK_FCF22AF461220EA6 FOREIGN KEY (creator_id) REFERENCES "user" (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_FCF22AF4CC3FBFA2 FOREIGN KEY (favorit_id) REFERENCES "user" (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
