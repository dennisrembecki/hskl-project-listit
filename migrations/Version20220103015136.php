 ...
 */
final class Version20220103015136 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__liste_element AS SELECT id, liste_id, creator_id, name, description, img, date FROM liste_element');
        $this->addSql('DROP TABLE liste_element');
        $this->addSql('CREATE TABLE liste_element (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, liste_id INTEGER NOT NULL, creator_id INTEGER NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, description CLOB DEFAULT NULL, img VARCHAR(255) DEFAULT NULL COLLATE BINARY, date DATETIME DEFAULT NULL, info VARCHAR(255) DEFAULT NULL, CONSTRAINT FK_F07AC668E85441D8 FOREIGN KEY (liste_id) REFERENCES liste (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_F07AC66861220EA6 FOREIGN KEY (creator_id) REFERENCES "user" (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO liste_element (id, liste_id, creator_id, name, description, img, date) SELECT id, liste_id, creator_id, name, description, img, date FROM __temp__liste_element');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__vote AS SELECT id, creator_id, element_id, value FROM vote');
        $this->addSql('DROP TABLE vote');
        $this->addSql('CREATE TABLE vote (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, creator_id INTEGER DEFAULT NULL, element_id INTEGER DEFAULT NULL, value INTEGER NOT NULL, CONSTRAINT FK_5A10856461220EA6 FOREIGN KEY (creator_id) REFERENCES "user" (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_5A1085641F1F2A24 FOREIGN KEY (element_id) REFERENCES liste_element (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO vote (id, creator_id, element_id, value) SELECT id, creator_id, element_id, value FROM __temp__vote');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__liste_element AS SELECT id, liste_id, creator_id, name, description, img, date FROM liste_element');
        $this->addSql('DROP TABLE liste_element');
        $this->addSql('CREATE TABLE liste_element (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, liste_id INTEGER NOT NULL, creator_id INTEGER NOT NULL, name VARCHAR(255) NOT NULL, description CLOB DEFAULT NULL COLLATE BINARY, img VARCHAR(255) DEFAULT NULL, date DATETIME DEFAULT NULL)');
        $this->addSql('INSERT INTO liste_element (id, liste_id, creator_id, name, description, img, date) SELECT id, liste_id, creator_id, name, description, img, date FROM __temp__liste_element');
        $this->addSql('DROP TABLE __temp__liste_element');
        $this->addSql('CREATE INDEX IDX_F07AC668E85441D8 ON liste_element (liste_id)');
        $this->addSql('CREATE INDEX IDX_F07AC66861220EA6 ON liste_element (creator_id)');
