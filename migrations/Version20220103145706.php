 ...
 */
final class Version20220103145706 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE vote (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, creator_id INTEGER DEFAULT NULL, element_id INTEGER DEFAULT NULL, value INTEGER NOT NULL, type VARCHAR(255) DEFAULT NULL, CONSTRAINT FK_5A10856461220EA6 FOREIGN KEY (creator_id) REFERENCES "user" (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_5A1085641F1F2A24 FOREIGN KEY (element_id) REFERENCES liste_element (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
